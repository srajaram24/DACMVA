...
from DNA_mRNA.TrainVAEExperiments import TrainVAEExperimentsClass
...
def runTrainMultiSurv(config,save_dir,max_epochs,missingPercent,dataloaderDir,gpu,dataLocationTest,modelLocation,modelLocEpoch,fixedConfig=False):
    MultisurvTrainer=TrainVAEExperimentsClass(config,save_dir,max_epochs,missingPercent,dataloaderDir,gpu,dataLocationTest,modelLocation,modelLocEpoch,fixedConfig)    
